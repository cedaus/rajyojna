"""
Django settings for rajyojna project.
...
SECRET_KEY = 'g8a=&_a^rv0g-&l_f-v2bg8kh6pf^*jt3o9=ce77r%_wc1v=sk'
...
WSGI_APPLICATION = 'rajyojna.wsgi.application'
